...
public class HearingVacatedBPMNTest {
    ...
    private static final String HEARING_VACATED_BPMN_FILE_NAME = "hearing-vacated.bpmn";
    private static final String CANCEL_INTERPRETERS_CASE_TASK_ID = "Cancel_interpreter_case";
    private static final String CANCEL_INTERPRETERS_CASE_PREFIX = "Cancel_interpreter_case_";
    private static final String CANCEL_INTERPRETERS_APPLICATION_TASK_ID = "Cancel_interpreter_application";
    private static final String CANCEL_INTERPRETERS_APPLICATION_PREFIX = "Cancel_interpreter_application_";

    // Fields
    private static final String CANCEL_INTERPRETER_FIELD = "hasInterpreter";
    private static final String HAS_CASES_FIELD = "hasCases";
    ...
    private static final String DEFENDANT_REMAND_STATUS = "Remand In Custody";
    ...
    @Test
    @Deployment(resources = {HEARING_VACATED_BPMN_FILE_NAME})
    public void shouldStartVacateHearingProcessForCaseWithCancelInterpretersTask() {

        final HashMap<String, Object> processVariables = new HashMap<>();
        processVariables.put(CANCEL_INTERPRETER_FIELD, true);
        processVariables.put(HAS_CASES_FIELD, true);
        processVariables.put(CANCEL_INTERPRETERS_CASE_PREFIX+TASK_NAME_FIELD, CANCEL_INTERPRETERS_CASE_TASK_ID);
        ...
        processVariables.put(CANCEL_INTERPRETERS_CASE_PREFIX+DEEP_LINK_FIELD, CASE_DEEP_LINK);
        processVariables.put(DEFENDANT_REMAND_STATUS_FIELD, DEFENDANT_REMAND_STATUS);
        processVariables.put(CANCEL_INTERPRETERS_CASE_PREFIX+WORK_QUEUE_FIELD, WORK_QUEUE);
        processVariables.put(CASE_URN_FIELD, CASE_URN);
        processVariables.put(CANCEL_INTERPRETERS_CASE_PREFIX+DUE_DATE_FIELD, DUE_DATE);
        ...
        processVariables.put(CANCEL_INTERPRETERS_CASE_PREFIX+TASK_TYPE_ID, TASK_TYPE_ID_VALUE);
        processVariables.put(CANCEL_INTERPRETERS_CASE_PREFIX+IS_DELETABLE_FIELD, true);
        processVariables.put(CANCEL_INTERPRETERS_CASE_PREFIX+IS_DEFERRABLE_FIELD, true);

        final ProcessInstance processInstance = runtimeService
                .startProcessInstanceByKey(HEARING_VACATED_BPMN_PROCESS_NAME, HEARING_ID, processVariables);
        ...
        assertThat(actualCancelInterpretersTask.getTaskDefinitionKey(), is(CANCEL_INTERPRETERS_CASE_TASK_ID));
        ...
        assertThat(runtimeService.getVariable(actualCancelInterpretersTaskExecutionId, CANCEL_INTERPRETERS_CASE_PREFIX+DEEP_LINK_FIELD), is(CASE_DEEP_LINK));
        assertThat(runtimeService.getVariable(actualCancelInterpretersTaskExecutionId, CANCEL_INTERPRETERS_CASE_PREFIX+WORK_QUEUE_FIELD), is(WORK_QUEUE));
        ...
        assertThat(runtimeService.getVariable(actualCancelInterpretersTaskExecutionId, CANCEL_INTERPRETERS_CASE_PREFIX+TASK_TYPE_ID), is(TASK_TYPE_ID_VALUE));
        assertThat(runtimeService.getVariable(actualCancelInterpretersTaskExecutionId, CANCEL_INTERPRETERS_CASE_PREFIX+IS_DELETABLE_FIELD), is(true));
        assertThat(runtimeService.getVariable(actualCancelInterpretersTaskExecutionId, CANCEL_INTERPRETERS_CASE_PREFIX+IS_DEFERRABLE_FIELD), is(true));
        ...
        MatcherAssert.assertThat(executionList.size(), is(2));
        ...
        assertThat(runtimeService.getVariable(execution, DEFENDANT_REMAND_STATUS_FIELD), is(DEFENDANT_REMAND_STATUS));
        assertThat(runtimeService.getVariable(execution, CANCEL_INTERPRETERS_CASE_PREFIX+DEEP_LINK_FIELD), is(CASE_DEEP_LINK));
        assertThat(runtimeService.getVariable(execution, CANCEL_INTERPRETERS_CASE_PREFIX+WORK_QUEUE_FIELD), is(WORK_QUEUE));
        ...
        assertThat(runtimeService.getVariable(execution, CANCEL_INTERPRETERS_CASE_PREFIX+TASK_TYPE_ID), is(TASK_TYPE_ID_VALUE));
    }

    @Test
    @Deployment(resources = {HEARING_VACATED_BPMN_FILE_NAME})
    public void shouldStartVacateHearingProcessForApplicationWithCancelInterpretersTask() {

        final HashMap<String, Object> processVariables = new HashMap<>();
        processVariables.put(CANCEL_INTERPRETER_FIELD, true);
        processVariables.put(HAS_CASES_FIELD, false);
        processVariables.put(CANCEL_INTERPRETERS_APPLICATION_PREFIX+TASK_NAME_FIELD, CANCEL_INTERPRETERS_APPLICATION_TASK_ID);
        processVariables.put(APPLICATION_ID_FIELD, APPLICATION_ID);
        processVariables.put(DEFENDANT_ID_FIELD, DEFENDANT_ID);
        processVariables.put(HEARING_ID_FIELD, HEARING_ID);
        processVariables.put(HEARING_DATE_FIELD, HEARING_DATE);
        processVariables.put(DEFENDANT_NAME_FIELD, DEFENDANT_NAME);
        processVariables.put(CANCEL_INTERPRETERS_APPLICATION_PREFIX+DEEP_LINK_FIELD, APPLICATION_DEEP_LINK);
        processVariables.put(DEFENDANT_REMAND_STATUS_FIELD, DEFENDANT_REMAND_STATUS);
        processVariables.put(CANCEL_INTERPRETERS_APPLICATION_PREFIX+WORK_QUEUE_FIELD, WORK_QUEUE);
        processVariables.put(CANCEL_INTERPRETERS_APPLICATION_PREFIX+DUE_DATE_FIELD, DUE_DATE);
        processVariables.put(LAST_UPDATED_BY_ID, SYSTEM_USER_ID);
        processVariables.put(LAST_UPDATED_BY_NAME, SYSTEM_USER_NAME);
        processVariables.put(JURISDICTION, CROWN_JURISDICTION_TYPE);
        processVariables.put(CANCEL_INTERPRETERS_APPLICATION_PREFIX+TASK_TYPE_ID, TASK_TYPE_ID_VALUE);
        processVariables.put(CASE_URN_FIELD, CASE_URN);
        processVariables.put(CANCEL_INTERPRETERS_APPLICATION_PREFIX+IS_DELETABLE_FIELD, true);
        processVariables.put(CANCEL_INTERPRETERS_APPLICATION_PREFIX+IS_DEFERRABLE_FIELD, true);
        ...
        final Task actualCancelInterpretersTask = activeTaskList.get(0);
        assertThat(actualCancelInterpretersTask.getTaskDefinitionKey(), is(CANCEL_INTERPRETERS_APPLICATION_TASK_ID));
        ...
        assertThat(runtimeService.getVariable(actualCancelInterpretersTaskExecutionId, DEFENDANT_NAME_FIELD), is(DEFENDANT_NAME));
        assertThat(runtimeService.getVariable(actualCancelInterpretersTaskExecutionId, DEFENDANT_REMAND_STATUS_FIELD), is(DEFENDANT_REMAND_STATUS));
        assertThat(runtimeService.getVariable(actualCancelInterpretersTaskExecutionId, CANCEL_INTERPRETERS_APPLICATION_PREFIX+DEEP_LINK_FIELD), is(APPLICATION_DEEP_LINK));
        assertThat(runtimeService.getVariable(actualCancelInterpretersTaskExecutionId, CANCEL_INTERPRETERS_APPLICATION_PREFIX+WORK_QUEUE_FIELD), is(WORK_QUEUE));
        assertThat(runtimeService.getVariable(actualCancelInterpretersTaskExecutionId, LAST_UPDATED_BY_ID), is(SYSTEM_USER_ID));
        assertThat(runtimeService.getVariable(actualCancelInterpretersTaskExecutionId, LAST_UPDATED_BY_NAME), is(SYSTEM_USER_NAME));
        assertThat(runtimeService.getVariable(actualCancelInterpretersTaskExecutionId, CANCEL_INTERPRETERS_APPLICATION_PREFIX+TASK_TYPE_ID), is(TASK_TYPE_ID_VALUE));
        ...
        assertThat(runtimeService.getVariable(execution, APPLICATION_ID_FIELD), is(APPLICATION_ID));
        assertThat(runtimeService.getVariable(execution, HEARING_ID_FIELD), is(HEARING_ID));
        assertThat(runtimeService.getVariable(execution, HEARING_DATE_FIELD), is(HEARING_DATE));
        assertThat(runtimeService.getVariable(execution, DEFENDANT_ID_FIELD), is(DEFENDANT_ID));
        assertThat(runtimeService.getVariable(execution, DEFENDANT_NAME_FIELD), is(DEFENDANT_NAME));
        assertThat(runtimeService.getVariable(execution, DEFENDANT_REMAND_STATUS_FIELD), is(DEFENDANT_REMAND_STATUS));
        assertThat(runtimeService.getVariable(execution, CANCEL_INTERPRETERS_APPLICATION_PREFIX+DEEP_LINK_FIELD), is(APPLICATION_DEEP_LINK));
        assertThat(runtimeService.getVariable(execution, CANCEL_INTERPRETERS_APPLICATION_PREFIX+WORK_QUEUE_FIELD), is(WORK_QUEUE));
        assertThat(runtimeService.getVariable(execution, LAST_UPDATED_BY_ID), is(SYSTEM_USER_ID));
        assertThat(runtimeService.getVariable(execution, LAST_UPDATED_BY_NAME), is(SYSTEM_USER_NAME));
        assertThat(runtimeService.getVariable(execution, JURISDICTION), is(CROWN_JURISDICTION_TYPE));
        assertThat(runtimeService.getVariable(execution, CANCEL_INTERPRETERS_APPLICATION_PREFIX+TASK_TYPE_ID), is(TASK_TYPE_ID_VALUE));
    }

    @Test
    @Deployment(resources = {HEARING_VACATED_BPMN_FILE_NAME})
    public void shouldStartAndStopVacateHearingProcessWhenNoTasksRequired() {

        final HashMap<String, Object> processVariables = new HashMap<>();
        processVariables.put(CANCEL_INTERPRETER_FIELD, false);
